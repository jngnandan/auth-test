...
import { useNavigate, Redirect, Navigate } from "react-router-dom"; // v6
...
export class Login extends Component {
    ...
    render() {
        return <div className='flex flex-row justify-center items-center h-screen'>
            <img className='w-40 m-8' src="https://assets.ccbp.in/frontend/react-js/nxt-trendz-login-img.png" />
